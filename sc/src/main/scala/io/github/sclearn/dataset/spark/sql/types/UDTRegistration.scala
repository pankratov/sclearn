...
import io.github.sclearn.dataset.spark.SparkException
import io.github.sclearn.dataset.spark.internal.Logging
import io.github.sclearn.dataset.spark.util.Utils
...
object UDTRegistration extends Serializable with Logging {
  ...
  private lazy val udtMap: mutable.Map[String, String] = mutable.Map(
    ("io.github.sclearn.dataset.spark.ml.linalg.Vector", "io.github.sclearn.dataset.spark.ml.linalg.VectorUDT"),
    ("io.github.sclearn.dataset.spark.ml.linalg.DenseVector", "io.github.sclearn.dataset.spark.ml.linalg.VectorUDT"),
    ("io.github.sclearn.dataset.spark.ml.linalg.SparseVector", "io.github.sclearn.dataset.spark.ml.linalg.VectorUDT"),
    ("io.github.sclearn.dataset.spark.ml.linalg.Matrix", "io.github.sclearn.dataset.spark.ml.linalg.MatrixUDT"),
    ("io.github.sclearn.dataset.spark.ml.linalg.DenseMatrix", "io.github.sclearn.dataset.spark.ml.linalg.MatrixUDT"),
    ("io.github.sclearn.dataset.spark.ml.linalg.SparseMatrix", "io.github.sclearn.dataset.spark.ml.linalg.MatrixUDT"))
